      ...
      <header className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md z-50 border-b border-gray-100">
        ...
        <div className={`md:hidden ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
          <div className="px-4 pt-2 pb-3 space-y-1 bg-white border-t border-gray-100">
            <a href="#" className="block px-3 py-2 text-base font-medium text-gray-600 hover:text-black hover:bg-gray-50 rounded-md">
              Products
            </a>
            <a href="#" className="block px-3 py-2 text-base font-medium text-gray-600 hover:text-black hover:bg-gray-50 rounded-md">
              Solutions
            ...
            <div className="pt-4 border-t border-gray-200">
              ...
              <a href="#" className="block px-3 py-2 text-base font-medium text-white bg-black hover:bg-gray-800 rounded-md text-center mt-2">
                Sign Up
              </a>
            </div>
          </div>
